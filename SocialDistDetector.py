...
#Function to check if the euclidean distance between two people is less than the range
def Check(a,  b):
...
yolo = "yolo-coco"
opname = "output_of_" + filename[:-4] + '.avi'
cap = cv2.VideoCapture(filename)

#main function
time1 = time.time() #Used to calculate time taken to perform the whole operation
while(True):
